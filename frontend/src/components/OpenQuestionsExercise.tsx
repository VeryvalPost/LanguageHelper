  ...
  return (
    <div className="max-w-2xl mx-auto">
      ...
      <div className="text-center mb-8">
        ...
        <p className="text-gray-600">Upload a PDF or image file (PDF, JPG, JPEG, PNG, BMP, GIF, TIFF, TIF) to generate an interactive exercise</p>
      </div>

      <div
        className={`relative border-2 border-dashed rounded-xl p-12 text-center transition-all duration-200 ${dragActive ? 'border-blue-400 bg-blue-50' : 'border-gray-300 hover:border-gray-400'}`}
      ...
      >
        ...
        {isUploading ? (
          ...
          <div className="flex flex-col items-center">
            ...
            <p className="text-lg font-medium text-gray-700 mb-2">{dragActive ? 'Drop your PDF or image here' : 'Upload your PDF or image file'}</p>
            <p className="text-sm text-gray-500">Drag and drop or click to select (PDF, JPG, JPEG, PNG, BMP, GIF, TIFF, TIF)</p>
          </div>
        )}
      </div>
